...
;
	($.$tale_ui_card) = class $tale_ui_card extends ($.$mol_view) {};
...
;
	($.$tale_battle) = class $tale_battle extends ($.$mol_book2) {
		...
		Hero_info(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this?.hero_info()));
			return obj;
		}
		Hero_card(){
			const obj = new this.$.$tale_ui_card();
			(obj.sub) = () => ([(this?.Hero_info())]);
			return obj;
		}
		enemy_info(){
			return "";
		...
		Enemy_info(){
			const obj = new this.$.$mol_text();
			(obj.text) = () => ((this?.enemy_info()));
			return obj;
		}
		Enemy_card(){
			const obj = new this.$.$tale_ui_card();
			(obj.sub) = () => ([(this?.Enemy_info())]);
			return obj;
		}
		hero_attack(next){
			if(next !== undefined) return next;
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $tale_battle.prototype, "enemy", null);
        __decorate([
            $mol_action
...
;
	($.$tale_app_hero) = class $tale_app_hero extends ($.$mol_book2) {
		hero_name(next){
			if(next !== undefined) return next;
			return "";
		}
		Hero_name(){
			const obj = new this.$.$mol_string();
			(obj.value) = (next) => ((this?.hero_name(next)));
			return obj;
		}
		Hero_name_labeler(){
		...
		Hero(){
			const obj = new this.$.$mol_page();
			(obj.title) = () => ("Герой");
			(obj.body) = () => ([(this?.Hero_name_labeler())]);
			return obj;
		}
		pages(){
			return [(this?.Hero())];
	...
	($mol_mem(($.$tale_app_hero.prototype), "hero_name"));
	($mol_mem(($.$tale_app_hero.prototype), "Hero_name"));
	($mol_mem(($.$tale_app_hero.prototype), "Hero_name_labeler"));
	($mol_mem(($.$tale_app_hero.prototype), "Hero"));
...
var $;
(function ($) {
    class $tale_dao_unit extends $hyoo_crus_entity.with({
        name: $hyoo_crus_atom_str,
    }) {
    }
    $.$tale_dao_unit = $tale_dao_unit;
})($ || ($ = {}));
...
var $;
(function ($) {
    class $tale_dao_user extends $hyoo_crus_entity.with({
        Hero: $tale_dao_unit,
    }) {
    }
    $.$tale_dao_user = $tale_dao_user;
})($ || ($ = {}));
...
(function ($) {
    ...
    (function ($$) {
        ...
        __decorate([
            $mol_mem
        ], $tale_app_hero.prototype, "hero_name", null);
        $$.$tale_app_hero = $tale_app_hero;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
...
;
	($.$tale_app) = class $tale_app extends ($.$mol_book2_catalog) {
		Theme(){
		...
		Source(){
			...
			(obj.uri) = () => ("https://github.com/Lyumih/tale");
			return obj;
		}
		user_id(){
			return "";
		...
		Battle(){
			const obj = new this.$.$tale_battle();
			return obj;
		}
		Hero(){
			const obj = new this.$.$tale_app_hero();
			return obj;
		}
		menu_title(){
			return "Hero Tale";
		...
		spreads(){
			return {"battle": (this?.Battle()), "hero": (this?.Hero())};
		}
	};
	($mol_mem(($.$tale_app.prototype), "Theme"));
	($mol_mem(($.$tale_app.prototype), "Source"));
	($mol_mem(($.$tale_app.prototype), "User_id"));
	($mol_mem(($.$tale_app.prototype), "Crus_status"));
	($mol_mem(($.$tale_app.prototype), "Battle"));
	($mol_mem(($.$tale_app.prototype), "Hero"));
